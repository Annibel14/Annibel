...
<form method="GET" action="conexion.php">
    ...
    <section class="form-register">
       ...
       Año de graduación:
       <br>
        <SELECT NAME="Años de graduación">
...
<br>
<SELECT NAME="Instituto educativo a la que pertenece">
...
<br><br>País de nacionalidad
        <br>
        <SELECT NAME="País de nacionalidad">
